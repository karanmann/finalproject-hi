export const otherInfo = {
    data: {
        ...
        shippingDetail:
            '#MB2 will update the shipping status above if there are any major delays, like if the vinyl supplier sends the wrong paint, or the box supplier delays the boxes etc.',
        mb2Title: '#MB2',
        mb2Detail: ' 75% SCALE ART SCULPTURES',
        titleInTheBox: 'IN THE BOX',
        inTheBox: [
            'Gloves to keep little fingerprints away',
